...
<img src="./assets/banner.svg" alt="Awesome Online Reputation Management Banner" width="100%" />
...
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](https://github.com/ishandutta2007/Awesome-Online-Reputation-Management/pulls)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](https://opensource.org/licenses/MIT)
[![Tracked Category](https://img.shields.io/badge/Category-ORM%20%26%20Social%20Listening-blue?style=flat-square)](https://github.com/ishandutta2007/Awesome-Online-Reputation-Management)
...
| **[dgtlmoon/changedetection.io](https://github.com/dgtlmoon/changedetection.io)** | [![Stars](https://img.shields.io/github/stars/dgtlmoon/changedetection.io?style=social&color=white)](https://github.com/dgtlmoon/changedetection.io/stargazers) | Self-hosted web page change monitoring and notification tool for tracking review sites and brand mentions. | Web Monitoring & Alerts |
| **[ArchiveBox/ArchiveBox](https://github.com/ArchiveBox/ArchiveBox)** | [![Stars](https://img.shields.io/github/stars/ArchiveBox/ArchiveBox?style=social&color=white)](https://github.com/ArchiveBox/ArchiveBox/stargazers) | Open-source self-hosted web archiving solution to preserve evidentiary snapshots of public mentions and reviews. | Evidence Preservation |
| **[twintproject/twint](https://github.com/twintproject/twint)** | [![Stars](https://img.shields.io/github/stars/twintproject/twint?style=social&color=white)](https://github.com/twintproject/twint/stargazers) | Advanced Twitter scraping tool written in Python that allows scraping Tweets without Twitter's API limits. | Social Media Scraping |
| **[nltk/nltk](https://github.com/nltk/nltk)** | [![Stars](https://img.shields.io/github/stars/nltk/nltk?style=social&color=white)](https://github.com/nltk/nltk/stargazers) | Comprehensive Natural Language Toolkit for text processing, tokenization, sentiment analysis, and classification. | NLP & Text Mining |
| **[flairNLP/flair](https://github.com/flairNLP/flair)** | [![Stars](https://img.shields.io/github/stars/flairNLP/flair?style=social&color=white)](https://github.com/flairNLP/flair/stargazers) | Powerful PyTorch NLP framework for state-of-the-art multilingual sentiment analysis and entity recognition. | Deep Learning Sentiment |
| **[sloria/TextBlob](https://github.com/sloria/TextBlob)** | [![Stars](https://img.shields.io/github/stars/sloria/TextBlob?style=social&color=white)](https://github.com/sloria/TextBlob/stargazers) | Simplified Pythonic library for processing textual data and extracting polarity/subjectivity sentiment scores. | Sentiment Analysis |
| **[stanfordnlp/stanza](https://github.com/stanfordnlp/stanza)** | [![Stars](https://img.shields.io/github/stars/stanfordnlp/stanza?style=social&color=white)](https://github.com/stanfordnlp/stanza/stargazers) | Stanford Official Python NLP toolkit for multilingual text analytics, dependency parsing, and sentiment extraction. | Multilingual NLP |
| **[cjhutto/vaderSentiment](https://github.com/cjhutto/vaderSentiment)** | [![Stars](https://img.shields.io/github/stars/cjhutto/vaderSentiment?style=social&color=white)](https://github.com/cjhutto/vaderSentiment/stargazers) | Rule-based sentiment analysis tool specifically attuned to social media sentiments and microblog text. | Social Sentiment Scoring |
| **[feedbin/feedbin](https://github.com/feedbin/feedbin)** | [![Stars](https://img.shields.io/github/stars/feedbin/feedbin?style=social&color=white)](https://github.com/feedbin/feedbin/stargazers) | Web-based RSS and media aggregator for centralizing real-time news alerts, press mentions, and blog coverage. | RSS Feed Monitoring |
| **[boy-jer/apphera](https://github.com/boy-jer/apphera)** | [![Stars](https://img.shields.io/github/stars/boy-jer/apphera?style=social&color=white)](https://github.com/boy-jer/apphera/stargazers) | Open-source internet and social media monitoring platform covering reviews, competitor analysis, and keywords. | Review & Social Suite |
| **[VladUZH/harken](https://github.com/VladUZH/harken)** | [![Stars](https://img.shields.io/github/stars/VladUZH/harken?style=social&color=white)](https://github.com/VladUZH/harken/stargazers) | Self-hosted social listening tool that tracks mentions across Reddit, Hacker News, Mastodon, Bluesky, and RSS. | Self-Hosted Social Listening |
| **[HasData/social-listening-tool](https://github.com/HasData/social-listening-tool)** | [![Stars](https://img.shields.io/github/stars/HasData/social-listening-tool?style=social&color=white)](https://github.com/HasData/social-listening-tool/stargazers) | Automated Python-based social listening pipeline capturing mentions across Instagram, TikTok, Reddit, and X. | Cross-Platform Listener |
| **[brightdata/brand-reputation-monitor](https://github.com/brightdata/brand-reputation-monitor)** | [![Stars](https://img.shields.io/github/stars/brightdata/brand-reputation-monitor?style=social&color=white)](https://github.com/brightdata/brand-reputation-monitor/stargazers) | Workflow for monitoring Google News brand mentions, running OpenAI sentiment analysis, and generating alerts. | AI News & Reputation Agent |
...
```mermaid
graph TD
    A[Public Web & Social Feeds] -->|Scrape / Ingest| B(Open Aggregator: Harken / Changedetection)
    A -->|Search Engines| C(SearXNG Metasearch)
    B & C --> D{NLP Sentiment Processing}
    D -->|VADER / spaCy / Flair| E[Sentiment & Topic Tagging]
    E --> F[Local Database / SQLite / PostgreSQL]
    F --> G[BI Visualization: Grafana / Metabase]
    E -->|Negative Spikes / Crisis| H[Instant Webhook / Telegram / Slack Alerts]
```
...
[![Star History Chart](https://star-history.dera.page/svg?repos=ishandutta2007/Awesome-Online-Reputation-Management&type=date&legend=top-left)](https://star-history.dera.page/#ishandutta2007/Awesome-Online-Reputation-Management&type=date&legend=top-left)
...
<div align="center">
  <b>Built for Marketing Leaders, PR Strategists, CX Teams, and Open-Source Engineers.</b><br/>
